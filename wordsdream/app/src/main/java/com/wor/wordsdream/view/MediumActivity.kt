...
import com.wor.wordsdream.databinding.ActivityMediumBinding
import java.util.*
...
class MediumActivity : AppCompatActivity() {
    ...
    private var keys = arrayOf("С","О","Н","Ц","Е")
    private val textAnswer = "СОНЦЕ"
    ...
    private fun doValidate() {
        ...
        if (binding.editText.text.toString() == textAnswer) {
            ...
            val a = Intent(this@MediumActivity, FinishActivity::class.java)
            startActivity(a)
            binding.editText.setText("")
        } else {
            Toast.makeText(this@MediumActivity, "Неправильно написанное слово!", Toast.LENGTH_SHORT).show()
            binding.editText.setText("")
        }
